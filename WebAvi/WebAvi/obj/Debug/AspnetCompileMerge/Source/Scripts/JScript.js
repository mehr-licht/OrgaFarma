...
function choose2array(wch, now, last, b4last, _2b4last, _3b4last, _4b4last) {
    ...
    for (var m = 1; m <= mostrar; m++) {
        ...
        if (jQuery.inArray(arrayold[m], arraypvp) < 0) {   // Element was not found, add it.
            if (arrayold[m] != 0) {
                arraypvp.push(arrayold[m]);
            }
        }
