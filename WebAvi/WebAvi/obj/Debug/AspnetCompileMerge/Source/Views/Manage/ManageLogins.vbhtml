                                ...
                                @If ViewBag.ShowRemoveButton
                                    @Using Html.BeginForm("RemoveLogin", "Manage")
                                        ...
                                        @<div>
                                            ...
                                            <input type="submit" class="btn btn-default" value="Remover" title="Removee este @account.LoginProvider login da sua conta" />
                                        </div>
                                    End Using
                                Else
                                    @: &nbsp;
            ...
            @Using Html.BeginForm("LinkLogin", "Manage")
                ...
                <p>
                    @For Each p As AuthenticationDescription In Model.OtherLogins
                        @<button type="submit" class="btn btn-default" id="@p.AuthenticationType" name="provider" value="@p.AuthenticationType" title="Entrar com a sua @p.Caption conta">@p.AuthenticationType</button>
                    Next
                </p>
                </div>
            End Using
