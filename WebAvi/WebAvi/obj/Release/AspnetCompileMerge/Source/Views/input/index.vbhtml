...
@Styles.Render("~/Content//tooltipster.css")
...
<body class="cbp-spmenu-push">
    ...
    <nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-right" id="cbp-spmenu-s2">
        <a href="#" id="labelcnpem0" class="cnpem">0</a>
        <a href="#" id="labelcnpem0" class="cnpem">0</a>
        ...
        <form id="inputform" Class="form-large" onreset="limpar()">
            ...
            <div Class="col-md-12 col-xs-12">
                <div Class="col-md-6 col-xs-6 esquerda">
                    ...
                    <div Class="col-md-4 col-xs-4 prescritos">
                        ...
                        @Html.TextBox("p1", "", New With {.id = "p1", .class = "textbox", .tabindex = "1", .autocomplete = "off", .minlength = "7", .maxlength = "8", .size = "8", .required = "required", .autofocus = "autofocus"})<!--.onkeyup = "movetoNext(this, 'p2')", -->
                ...
                <div Class="col-md-6 col-xs-6 direita">
                    ...
                    <div Class="col-md-4 col-xs-4 aviados">
                        @Html.TextBox("a1", "", New With {.id = "a1", .class = "textbox", .tabindex = "5", .autocomplete = "off", .minlength = "7", .maxlength = "7", .onkeyup = "movetoNext(this, 'a2')", .size = "7", .required = "required"})<!-- -->
                    </div>

                    <div Class="col-md-4 col-xs-4 labellinha">
                        <Label for="aviado1" id="labellinha1" class="mostrado"></Label>
                    </div>
                </div>
            </div>
            ...
            <div Class="col-md-12 col-xs-12">
                <div Class="col-md-6 col-xs-6 esquerda">
                    ...
                    <div Class="col-md-4 col-xs-4 prescritos">
                        @Html.TextBox("p2", "", New With {.id = "p2", .class = "textbox", .tabindex = "2", .autocomplete = "off", .minlength = "7", .maxlength = "8", .size = "8"})<!--.onkeyup = "movetoNext(this, 'p3')",-->
                ...
                <div Class="col-md-6 col-xs-6 direita">
                    ...
                    <div Class="col-md-4 col-xs-4 aviados">
                        @Html.TextBox("a2", "", New With {.id = "a2", .class = "textbox", .tabindex = "6", .autocomplete = "off", .minlength = "7", .maxlength = "7", .onkeyup = "movetoNext(this, 'a3')", .size = "7"})<!---->
                    </div>
                    <div Class="col-md-4 col-xs-4 labellinha">
                        <Label for="aviado2" id="labellinha2" class="mostrado"></Label>
                    </div>
                </div>
            </div>
            ...
            <div Class="col-md-12 col-xs-12">
                <div Class="col-md-6 col-xs-6 esquerda">
                    ...
                    <div Class="col-md-4 col-xs-4 prescritos">
                        @Html.TextBox("p3", "", New With {.id = "p3", .class = "textbox", .tabindex = "3", .autocomplete = "off", .minlength = "7", .maxlength = "8", .size = "8"})<!-- .onkeyup = "movetoNext(this, 'p4')",-->
                    </div>
                </div>
                ...
                <div Class="col-md-6 col-xs-6 direita">
                    ...
                    <div Class="col-md-4 col-xs-4 aviados">
                        @Html.TextBox("a3", "", New With {.id = "a3", .class = "textbox", .tabindex = "7", .autocomplete = "off", .minlength = "7", .maxlength = "7", .onkeyup = "movetoNext(this, 'a4')", .size = "7"})<!-- -->
                    </div>
                    <div Class="col-md-4 col-xs-4 labellinha">
                        <Label for="aviado3" id="labellinha3" class="mostrado"></Label>
                    </div>
                </div>
            </div>
            ...
            <div Class="col-md-12 col-xs-12">
                <div Class="col-md-6 col-xs-6 esquerda">
                    ...
                    <div Class="col-md-4 col-xs-4 prescritos" >
                        @Html.TextBox("p4", "", New With {.id = "p4", .class = "textbox", .tabindex = "4", .autocomplete = "off", .minlength = "7", .maxlength = "8", .size = "8"})<!-- .onkeyup = "movetoNext(this, 'a1')", -->
                    </div>
                </div>
                ...
                <div Class="col-md-6 col-xs-6 direita">
                    ...
                    <div Class="col-md-4 col-xs-4 aviados">
                        @Html.TextBox("a4", "", New With {.id = "a4", .class = "textbox", .tabindex = "8", .autocomplete = "off", .minlength = "7", .maxlength = "7", .onkeyup = "movetoNext(this, 'btnSubmit')", .size = "7"})<!---->
                    </div>
                    <div Class="col-md-4 col-xs-4 labellinha">
                        <Label for="aviado4" id="labellinha4" class="mostrado"></Label>
                    </div>
                </div>
            </div>
            ...
            <div Class="col-md-12 col-xs-12">
                ...
                <div Class="col-md-6 col-xs-6 direita">
                    ...
                    <div Class="col-md-4 col-xs-4">
                        <input id="btnSubmit" type="button" onclick="toggle()" name="btnSubmit" value="comparar" tabindex="9" class="btn" />
